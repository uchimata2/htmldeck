...
| 6 · per-batch automatic checks | ~~The build check~~ — **built 2026-08-09.** `python ${CLAUDE_PLUGIN_ROOT}/tools/deck/check.py <deck> [--sources <dir>] [--print-pages] [--json]` gates 79 of the 111 rules the ruleset puts in its jurisdiction and **names every one of the other 32, with a reason**. | — |
