...
| 6 · per-batch automatic checks | ~~The build check~~ — **built 2026-08-09.** `python ${CLAUDE_PLUGIN_ROOT}/tools/deck/check.py <deck> [--sources <dir>] [--print-pages] [--json] [--quiet]` gates 82 of the 113 rules the ruleset puts in its jurisdiction and **names every one of the other 31, with a reason**. | — |
