...
| 6 · per-batch automatic checks | ~~The build check~~ — **built 2026-08-09.** `python $HTMLDECK/tools/deck/check.py <deck> [--sources <dir>] [--print-pages] [--json] [--quiet]` gates 93 of the 122 rules the ruleset puts in its jurisdiction and **names every one of the other 29, with a reason**. | — |
