...
| 2026-08-10 | (specify) | **Moved to `PH3`** under the release split set by the owner 2026-08-10. Estimates unchanged: `l` and a new capability is the definition of the later phase, and this task's own raising note already called it *the largest thing on the PH2 board and the least certain to be worth it*. |
