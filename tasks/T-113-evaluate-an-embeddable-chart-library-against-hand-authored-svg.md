...
| :--- | :--- | :--- |
| A chart-intensive deck exists first | **met** | `examples/portfolio-review/` — 12 slides, ten hand-authored SVG figures across seven chart kinds, real financial structure, green on every gate this repository owns. *Restated 2026-08-21 by [T-205](T-205-correct-r9s-gate-7-scoring-and-its-account-of-looking.md), because green on every gate was the whole of what this row claimed and the look behind it covered **ten of twelve slides**. Two further looks found six more defects — T-203 and T-207 — and the deck is now green after them. The criterion is met; what it was worth is smaller than it read, and the coverage figure is R9 §6.* |
| Every candidate has a verdict against all seven gates, with the failing gate named | **met** | R9 §3 to §5. Gate 3 eliminated nobody; gate 7 eliminated TanStack Charts, which is the only gate any candidate failed. *Restated 2026-08-21 by [T-205](T-205-correct-r9s-gate-7-scoring-and-its-account-of-looking.md): this row read **on age alone**, which was the summary's collapse rather than the measurement. It fails on `reliable` and `robust` — the missing track record — and leads the field on `recently` and `continuously updated`. R9 §3 now scores all six clauses.* |
...
| 2026-08-21 | (no change) | **The closing look above was incomplete, and the owner's review the same day found four more defects.** It covered **ten of twelve slides** — 9 and 12 were never opened — and passed three of the ten it did cover: the waterfall's connectors leave each bar at the wrong edge, the scatter's labels cross the reference diagonal, and the gated timeline's axis is drawn through the gate. Slide 9 spreads its body into the bottom line and the chrome. **Thirteen defects, not nine**, and every gate was green on all of them. The task stays `done` — the work is done and the criteria were met on their own terms — and the four fixes are [T-203](T-203-four-chart-defects-the-decks-look-missed.md), the missing instrument is [T-204](T-204-an-instrument-for-mark-collisions.md), and R9's account of what looking found is [T-205](T-205-correct-r9s-gate-7-scoring-and-its-account-of-looking.md). **What this record should have carried is the look's coverage, not its yield** — a claim about an instrument owes the instrument's reach. |
