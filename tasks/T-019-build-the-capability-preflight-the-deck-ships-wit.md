...
| :--- | :--- | :--- |
| 2026-08-11 | (shipped) | **Shipped in `0.2.1`.** DS-009 ships with it: every deck carries a capability preflight and a degraded state that is switched on in the source. |
