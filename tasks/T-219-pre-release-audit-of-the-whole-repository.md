...
| 24 | Research `R5`–`R9`, upstream, sketches, adopter reports | 38 | 305,209 | **Grade B.** `R8` against `AUDIT-METHOD.md`. The three upstream reports against what those projects did. An orphan sketch. The 27 adopter findings and their README against what [T-225](T-225-triage-the-claimai-adopter-report.md) decided about each. | pending |
| | *Stage 6 — outside git.* | | | | |
