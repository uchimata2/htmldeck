...
| 24 | Research `R5`–`R9`, upstream, sketches | 10 | 210,116 | **Grade B.** `R8` against `AUDIT-METHOD.md`. The three upstream reports against what those projects did. An orphan sketch. | pending |
| | *Stage 6 — outside git.* | | | | |
