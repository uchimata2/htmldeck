...
| [T-002](T-002-build-mode-the-self-contained-deck-generator.md) | Build mode — the self-contained deck generator | `v0.1` | `done` | `review` | - | - | T-003, T-004, T-005, T-006, T-007, T-015, T-016, T-017, T-018, T-020, T-021, T-023, T-024, T-026, T-027, T-028 |
...
| [T-080](T-080-check-resolves-a-markdown-link-inside-a-code-fence.md) | taskmd check resolves a markdown link inside a code fence, so pasted output cannot be quoted | `v0.2` | `done` | `review` | - | - | T-063, T-073, T-079, T-081, T-098 |
...
| [T-088](T-088-a-figure-in-a-sentence-naming-no-field-goes-stale-unwatched.md) | A figure in a sentence that names no field goes stale unwatched, and two just did | `v0.3` | `done` | `review` | - | - | T-060, T-068, T-077, T-082, T-092 |
