...
| [T-008](T-008-package-document-and-publish.md) | Package, document and publish | `v0.1` | `done` | `review` | - | - | T-002, T-004, T-005, T-056 | - | T-030, T-042, T-050, T-061, T-064, T-078 |
...
| [T-069](T-069-extend-the-provenance-mark-to-multiple-sources.md) | Extend the provenance mark to multiple sources, and decide where deck-wide sources go | `v0.2` | `done` | `review` | - | - | - | T-070, T-071 | T-016, T-070, T-084 |
