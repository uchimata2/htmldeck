...
| [T-135](T-135-cut-the-load-path-this-project-cannot-use.md) | Cut the load path this project cannot use | `PH3` | - | `in_progress` | `implement` | T-130 | - | T-130, T-134, T-136 |
| [T-136](T-136-re-run-the-external-research-with-a-recorded-search-record.md) | Re-run the external research with a recorded search record | `PH3` | - | `proposed` | `specify` | T-130 | - | T-130, T-135 |
...
| [T-130](T-130-audit-the-context-economy-of-an-agent-driven-repository.md) | Audit the context economy of an agent-driven repository, and rank the savings | `PH3` | - | `done` | `review` | - | T-131, T-132, T-133, T-134, T-135, T-136 | T-096, T-128, T-131, T-132, T-133, T-134, T-135, T-136 |
