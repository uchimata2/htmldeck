...
| [T-103](T-103-build-md-drops-ds-105s-link-clause-for-a-single-source-slide.md) | build.md drops DS-105's link clause for a single-source slide, so the mark does not read as provenance | `PH1` | `0.2.2` | `done` | `review` | - | - | T-069, T-070, T-092 |
