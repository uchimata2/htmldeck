...
- Out: everything the release phases put in PH2 — 3D ([T-057](T-057-the-3d-class-the-frame-rate-figure-and-ds-140s-fifth-motion.md)),
...
| Renders glitch-free from `file://` in recent Chrome/Edge, no console errors | **met** | The render gate ran over all twelve slides; the console-error condition is still R6's unimplemented seventh and is [T-041](T-041-implement-the-nine-glitch-free-conditions.md)'s, which the release phases put in PH2 |
