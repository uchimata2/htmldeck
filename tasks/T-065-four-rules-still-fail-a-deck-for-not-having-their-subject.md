...
| Every other verdict row checked for the same shape | **met** | Two candidates found, both cleared: DS-070 and DS-135 read `ALWAYS_MEASURED` keys, so `False` is a real verdict |
