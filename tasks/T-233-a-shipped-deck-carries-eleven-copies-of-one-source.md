...
| The quick view **opened and looked at** on the rebuilt deck, per `CLAUDE.md` rule 6 | owed | Recorded in [`docs/OWED-LOOKS.md`](../docs/OWED-LOOKS.md). `REMEDIATION-ORDER.md` §4: an unattended session may not look |
