...
```
OK - 1576 document pointer(s) checked, 0 broken
     637 section reference(s) resolved, 0 dead; 1594 not bound to a document and skipped.
```
...
[`examples/reference-deck.html`](examples/reference-deck.html) is 12 slides and a colophon, **261 KB
...
**258 KB in one file, zero external references**, six hand-written SVG figures and ten disclosure
