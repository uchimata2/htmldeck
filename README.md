...
```
OK - 1544 document pointer(s) checked, 0 broken
     625 section reference(s) resolved, 0 dead; 1578 not bound to a document and skipped.
```
...
[`examples/reference-deck.html`](examples/reference-deck.html) is 12 slides and a colophon, **253 KB
...
**250 KB in one file, zero external references**, six hand-written SVG figures and ten disclosure
