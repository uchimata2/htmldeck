...
[`examples/reference-deck.html`](examples/reference-deck.html) is 12 slides and a colophon, **329 KB
...
**328 KB in one file, zero external references**, six hand-written SVG figures and ten disclosure
