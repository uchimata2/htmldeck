...
[`examples/reference-deck.html`](examples/reference-deck.html) is 12 slides and a colophon, **272 KB
...
**270 KB in one file, zero external references**, six hand-written SVG figures and ten disclosure
