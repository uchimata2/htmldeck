...
**This file is over its own bound** — 16,073 bytes against `docs/AUDIT-METHOD.md`'s 8,040, measured
2026-09-14 with the command above, so the debt is 8,033. *The floor moved twice on 2026-09-02 and this
...
[T-295](tasks/T-295-complete-t-288s-observation-and-decide-the-move.md) and reversed the same day,
when a path-scoped rule was seen reaching the main context; the move is in progress there.
