...
**What exists.** `python tools/deck/check.py <deck>` decides 84 of the 115 rules a gate owns and
names the other 31 with a reason each; `skills/htmldeck/references/build.md` plus `shell/` turn a
