...
[`reference-deck.html`](reference-deck.html) is **317 KB in one file**, 324 110 bytes. Three embedded
...
reconciled against. It is **315 KB in one file**, 322 067 bytes, 12 slides, six hand-written SVG
...
colophon. It is
**427 KB in one file**, 436 834 bytes, zero external references. It argues that measurement and
