...
[`reference-deck.html`](reference-deck.html) is **318 KB in one file**, 325 338 bytes. Three embedded
...
reconciled against. It is **317 KB in one file**, 324 357 bytes, 12 slides, six hand-written SVG
...
colophon. It is
**428 KB in one file**, 438 062 bytes, zero external references. It argues that measurement and
...
Infrastructure Fund - 2026 portfolio review*, 12 slides. It is **317 KB in one file**, 324 313 bytes,
