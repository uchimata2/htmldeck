...
[`reference-deck.html`](reference-deck.html) is **282 KB in one file**, 288 837 bytes. Three embedded
...
reconciled against. It is **280 KB in one file**, 286 870 bytes, 12 slides, six hand-written SVG
...
**390 KB in one file**, 398 940 bytes, zero external references. It argues that measurement and
