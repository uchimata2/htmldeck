...
[`reference-deck.html`](reference-deck.html) is **281 KB in one file**, 288 142 bytes. Three embedded
...
reconciled against. It is **279 KB in one file**, 286 175 bytes, 12 slides, six hand-written SVG
...
**389 KB in one file**, 398 830 bytes, zero external references. It argues that measurement and
