...
[`reference-deck.html`](reference-deck.html) is **328 KB in one file**, 336 195 bytes. Three embedded
...
reconciled against. It is **327 KB in one file**, 335 214 bytes, 12 slides, six hand-written SVG
...
colophon. It is
**438 KB in one file**, 448 919 bytes, zero external references. It argues that measurement and
...
Infrastructure Fund - 2026 portfolio review*, 12 slides. It is **327 KB in one file**, 335 144 bytes,
