...
[`reference-deck.html`](reference-deck.html) is **331 KB in one file**, 339 349 bytes. Three embedded
...
reconciled against. It is **330 KB in one file**, 338 368 bytes, 12 slides, six hand-written SVG
...
colophon. It is
**441 KB in one file**, 452 073 bytes, zero external references. It argues that measurement and
...
Infrastructure Fund - 2026 portfolio review*, 12 slides. It is **330 KB in one file**, 338 298 bytes,
