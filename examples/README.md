...
[`reference-deck.html`](reference-deck.html) is **344 KB in one file**, 352 209 bytes. Three embedded
...
reconciled against. It is **331 KB in one file**, 338 472 bytes, 12 slides, six hand-written SVG
...
colophon. It is
**442 KB in one file**, 452 177 bytes, zero external references. It argues that measurement and
...
Infrastructure Fund - 2026 portfolio review*, 12 slides. It is **330 KB in one file**, 338 402 bytes,
