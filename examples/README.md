...
[`reference-deck.html`](reference-deck.html) is **329 KB in one file**, 337 203 bytes. Three embedded
...
reconciled against. It is **328 KB in one file**, 336 222 bytes, 12 slides, six hand-written SVG
...
colophon. It is
**439 KB in one file**, 449 927 bytes, zero external references. It argues that measurement and
...
Infrastructure Fund - 2026 portfolio review*, 12 slides. It is **328 KB in one file**, 336 152 bytes,
