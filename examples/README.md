...
[`reference-deck.html`](reference-deck.html) is **319 KB in one file**, 326 876 bytes. Three embedded
...
reconciled against. It is **318 KB in one file**, 325 895 bytes, 12 slides, six hand-written SVG
...
colophon. It is
**429 KB in one file**, 439 600 bytes, zero external references. It argues that measurement and
...
Infrastructure Fund - 2026 portfolio review*, 12 slides. It is **318 KB in one file**, 325 851 bytes,
