...
[`reference-deck.html`](reference-deck.html) is **327 KB in one file**, 334 380 bytes. Three embedded
...
reconciled against. It is **326 KB in one file**, 333 399 bytes, 12 slides, six hand-written SVG
...
colophon. It is
**437 KB in one file**, 447 104 bytes, zero external references. It argues that measurement and
...
Infrastructure Fund - 2026 portfolio review*, 12 slides. It is **326 KB in one file**, 333 355 bytes,
