...
[`reference-deck.html`](reference-deck.html) is **322 KB in one file**, 329 302 bytes. Three embedded
...
reconciled against. It is **321 KB in one file**, 328 321 bytes, 12 slides, six hand-written SVG
...
colophon. It is
**432 KB in one file**, 442 026 bytes, zero external references. It argues that measurement and
...
Infrastructure Fund - 2026 portfolio review*, 12 slides. It is **321 KB in one file**, 328 277 bytes,
