...
[`reference-deck.html`](reference-deck.html) is **283 KB in one file**, 290 207 bytes. Three embedded
...
reconciled against. It is **281 KB in one file**, 288 240 bytes, 12 slides, six hand-written SVG
...
**391 KB in one file**, 400 424 bytes, zero external references. It argues that measurement and
