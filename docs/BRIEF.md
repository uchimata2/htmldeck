...
*The phase has reopened six times, and **the sixth is the first from outside this repository**: T-090
and T-091 were raised on 2026-08-11 by htmldeck's first adopting project, against the published
...
published one. The five before it were the project's own: `v0.1.1` through `v0.1.5`.*
