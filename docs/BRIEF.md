...
- ~~The build check demonstrated failing on each class of problem it claims to catch.~~ **Met
  ...
  `python tools/deck/check.py <deck> [--sources <dir>] [--print-pages] [--json]` decides **80 of the
  112 rules** the ruleset puts in a gate's jurisdiction and **names the other 32 with a reason and a
