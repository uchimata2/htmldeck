...
| 3 | T-137 | after 1 and 2, which it is blocked on in substance — the one run's evidence is freshest now and decays |
...
| 7 | T-109 | the hub of the source cluster; 8–10 are rework if it lands after them |
| 8–10 | T-110, T-118, T-121 | that cluster, downstream of the component decision |
| 11 | T-115 | needs 6 and 7 to have settled what the shell offers |
...
| 14 | T-054 | after 5, which may change which clauses are worth recording |
| 18 | T-113 | research, and it decides ground 19–22 build on |
| 19–20 | T-112, T-111 | the motion cluster, in that order |
| 21 | T-041 | named in *what PH1 shipped without* |
| 22 | T-057 | `xl`, and the least certain to be worth it |
