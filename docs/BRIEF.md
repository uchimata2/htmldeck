...
**`v0.1.6` is owed and carries three**: T-090, T-091 and T-094, all fixed and none shipped. The
sequence is [`PUBLISHING.md`](PUBLISHING.md) §8 and nothing else.
