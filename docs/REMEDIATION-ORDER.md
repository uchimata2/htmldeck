...
what B12 measured while closing `PR-84`. **`T-279` and `T-280` are done; `T-278` and `T-281` are
unbatched**, and §4's standing authorities do not reach them — they were asked for
