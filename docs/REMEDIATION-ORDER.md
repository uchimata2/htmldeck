...
directly, which outranks a standing authority rather than needing one. **A seventh joined at B13, and it is the first raised by §4's routing rather than by a ruling or a request**: [T-283](../tasks/T-283-ds-218-reports-a-pass-where-it-has-no-subject.md), the instrument half of what `T-257` measured. It is unbatched for the reason §4 gives — it changes a verdict for every deck the gate reads, which is *potential impact on other work* and so a task rather than a fix in place. *The title said* the 47 tasks *until 2026-08-29,
