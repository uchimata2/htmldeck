...
| 22 | **CE-22** | D / F3 | Output at five times the input rate was a quarter of the session's weighted spend, and the record forms are the mechanism — **collides with the project's record policy; reported for the owner, who ruled on 2026-09-13 that it becomes a decision** | *bimodal* | — | stated | §6.3 |
