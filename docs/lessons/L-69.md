...
4. **Renaming the phases ends the ambiguity, and this entry declined it before taking it a day
   ...
   fix went where somebody picks a number: [`../../CLAUDE.md`](../../CLAUDE.md), beside the release
   status. *It moved to [`../PUBLISHING.md`](../PUBLISHING.md) §8 on 2026-08-14 — the release sequence
   itself, which had never stated it. Tier 1 keeps the distinction and points there
